/*! \page Numerics Odeint SPH Dam break simulation with Dynamic load balacing on Multi-GPU
 *
 *
 * [TOC]
 *
 ...
 *
 * \snippet example/Numerics/OdeInt/SPH_dlb_gpu/main2.cu remove_marked_part
 *
 ...
 *
 * \snippet example/Numerics/OdeInt/SPH_dlb_gpu/main2.cu mark_to_remove_kernel
 *
 * ## Macro CUDA_LAUNCH
 *
 ...
 *
 * \include example/Numerics/OdeInt/SPH_dlb_gpu/main2.cu
 *
 */
...
/*! \brief A 3d Odeint compatible SPH kernel structure.
 *
 *  Use the method data.get<d>() to refer to property of all the particles in the dimension d.
 *
 */
...
/*! \brief A 3d Odeint compatible SPH structure.
 *
 *  Use the method data.get<d>() to refer to property of all the particles in the dimension d.
 *
 */
 ...
 * One can use openfpm defined types such as 'state_type_Nd_ofp_gpu' or use a custom one like 'sph_state_type_ofp_gpu'
 *
